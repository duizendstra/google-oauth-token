...
if os.environ.get('ALLOW_INSECURE_TRANSPORT') == '1':
    ...
    print("WARNING: OAUTHLIB_INSECURE_TRANSPORT is enabled.  For local development only!")

app = Flask(__name__)
app.secret_key = os.environ.get('FLASK_SECRET_KEY', os.urandom(24))  # From env or random
